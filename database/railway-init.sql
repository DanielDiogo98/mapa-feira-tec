...
('bloco-b-andar-2', 'Passagem Bloco A · Bloco B · 2º andar', 20498, 14433, 1),
...
('bloco-a-salas', 'point-cbd0e946-8560-488e-a63c-37047b62cf75', 'Sala 4 Bloco A', 'destination', 9663.63, 29960.06, 'sala-04'),
('bloco-a-salas', 'point-29219c08-d623-4539-b93f-dc5b5cb1147d', 'Sala 5 Bloco A', 'destination', 2518.52, 34602.74, 'sala-05'),
('bloco-a-salas', 'point-59797ffc-2dd5-4eb5-a188-8fa0a1792083', 'Sala 6 Bloco A', 'destination', 9466.07, 34701.52, 'sala-06'),
('bloco-a-salas', 'point-9a5b2e37-7289-4b47-9c1e-5c55c177e822', 'Sala 7 Bloco A', 'destination', 2386.81, 39311.27, 'sala-07'),
('bloco-a-salas', 'point-0e8ad8b5-cf50-4cf7-a50d-e41f9781540b', 'Sala 8 Bloco A', 'destination', 9531.93, 39245.42, 'sala-08'),
...
('bloco-b-andar-2', 'passagem-escada-patio', 'Escada para o pátio e salas do Bloco A', 'stairs', 19545, 4761, 'escada-acesso-patio-bloco-a'),
('bloco-b-andar-2', 'passagem-corredor-escada', 'Corredor da escada', 'corridor', 17300, 4761, 'corredor-passagem-bloco-a'),
('bloco-b-andar-2', 'passagem-corredor-lab-01', 'Corredor do Laboratório 1 do Bloco A', 'corridor', 17277.26, 2216.82, NULL),
('bloco-b-andar-2', 'passagem-lab-01-porta', 'Porta do Laboratório 1 do Bloco A', 'door', 16516.09, 2202.75, NULL),
('bloco-b-andar-2', 'passagem-lab-01-destino', 'Laboratório 1 · Bloco A · Passagem', 'destination', 15364.33, 2232.77, 'sala-lab-bloco-a-01'),
('bloco-b-andar-2', 'passagem-corredor-lab-02', 'Corredor do Laboratório 2 do Bloco A', 'corridor', 17277.26, 4357.61, NULL),
('bloco-b-andar-2', 'passagem-lab-02-porta', 'Porta do Laboratório 2 do Bloco A', 'door', 16577.26, 4357.61, NULL),
('bloco-b-andar-2', 'passagem-lab-02-destino', 'Laboratório 2 · Bloco A · Passagem', 'destination', 15286.89, 4413.16, 'sala-lab-bloco-a-02'),
('bloco-b-andar-2', 'passagem-corredor-lab-03', 'Corredor do Laboratório 3 do Bloco A', 'corridor', 17282.16, 6563.09, NULL),
('bloco-b-andar-2', 'passagem-lab-03-porta', 'Porta do Laboratório 3 do Bloco A', 'door', 16546.49, 6545.26, NULL),
('bloco-b-andar-2', 'passagem-lab-03-destino', 'Laboratório 3 · Bloco A · Passagem', 'destination', 15478.66, 6509.59, 'sala-lab-bloco-a-03'),
('bloco-b-andar-2', 'passagem-corredor-lab-04', 'Corredor do Laboratório 4 do Bloco A', 'corridor', 17300, 8592.37, NULL),
('bloco-b-andar-2', 'passagem-lab-04-porta', 'Porta do Laboratório 4 do Bloco A', 'door', 16582.16, 8610.21, NULL),
('bloco-b-andar-2', 'passagem-lab-04-destino', 'Laboratório 4 · Bloco A · Passagem', 'destination', 15550, 8556.7, 'sala-lab-bloco-a-04'),
('bloco-b-andar-2', 'passagem-corredor-central', 'Corredor de ligação dos blocos', 'corridor', 17300, 11500, NULL),
('bloco-b-andar-2', 'passagem-chegada-bloco-b', 'Chegada ao 2º andar do Bloco B', 'corridor', 6918.45, 11493.57, NULL),
('bloco-b-andar-2', 'b2-escada-destino', 'Escada para o 1º andar do Bloco B', 'stairs', 6263, 5006, 'escadas-acesso-patio'),
('bloco-b-andar-2', 'b2-escada-corredor', 'Corredor da escada', 'corridor', 4863, 5006, 'corredor-principal'),
('bloco-b-andar-2', 'b2-corredor-topo', 'Corredor superior', 'corridor', 4711.36, 11483.34, NULL),
('bloco-b-andar-2', 'b2-corredor-direito-topo', 'Corredor dos laboratórios', 'corridor', 3664.96, 11386.56, NULL),
('bloco-b-andar-2', 'b2-corredor-tcc', 'Corredor do Laboratório TCC', 'corridor', 3629.29, 8098.21, NULL),
('bloco-b-andar-2', 'b2-corredor-lab-04', 'Corredor do Laboratório 4', 'corridor', 3557.95, 5894.05, NULL),
('bloco-b-andar-2', 'b2-corredor-banheiro-masculino', 'Corredor do banheiro masculino', 'corridor', 4863, 2643, NULL),
('bloco-b-andar-2', 'b2-corredor-banheiro-feminino', 'Corredor do banheiro feminino', 'corridor', 4863, 1283, NULL),
('bloco-b-andar-2', 'b2-corredor-maker', 'Corredor do Laboratório Maker', 'corridor', 3575.79, 2426.51, NULL),
('bloco-b-andar-2', 'b2-quimica-01-porta', 'Porta do Laboratório de Química 1', 'door', 4653.6, 12317.38, NULL),
('bloco-b-andar-2', 'b2-quimica-01-destino', 'Laboratório de Química 1 · Bloco B · 2º andar', 'destination', 3650.9, 13533, 'sala-lab-quimica-01'),
('bloco-b-andar-2', 'b2-quimica-02-porta', 'Porta do Laboratório de Química 2', 'door', 1746.33, 11368.72, NULL),
('bloco-b-andar-2', 'b2-quimica-02-destino', 'Laboratório de Química 2 · Bloco B · 2º andar', 'destination', 873.82, 10994.19, 'sala-lab-quimica-02'),
('bloco-b-andar-2', 'b2-tcc-porta', 'Porta do Laboratório TCC', 'door', 1780, 8133.88, NULL),
('bloco-b-andar-2', 'b2-tcc-destino', 'Laboratório TCC · Bloco B · 2º andar', 'destination', 963, 8211.97, 'sala-lab-tcc'),
('bloco-b-andar-2', 'b2-lab-04-porta', 'Porta do Laboratório 4', 'door', 1744.33, 5822.71, NULL),
('bloco-b-andar-2', 'b2-lab-04-destino', 'Laboratório 4 · Bloco B · 2º andar', 'destination', 963, 5858.46, 'sala-lab-04'),
('bloco-b-andar-2', 'b2-maker-porta', 'Porta do Laboratório Maker', 'door', 1793, 2408.67, NULL),
('bloco-b-andar-2', 'b2-maker-destino', 'Laboratório Maker · Bloco B · 2º andar', 'destination', 963, 2433, 'sala-lab-maker'),
('bloco-b-andar-2', 'b2-banheiro-masculino-destino', 'Banheiro masculino · Bloco B · 2º andar', 'destination', 6463, 2643, 'banheiro-masculino'),
('bloco-b-andar-2', 'b2-banheiro-feminino-destino', 'Banheiro feminino · Bloco B · 2º andar', 'destination', 6463, 1283, 'banheiro-feminino'),
